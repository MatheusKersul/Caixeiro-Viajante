...
public interface Grafo {
     ...
     */
    public int grauDoVertice(Vertice vertice) throws Exception; //quantidade de arestas ligadas
    
    /**
     * Indica a cardinalidade do conjunto V.
     * @return número de vértices do grafo.
     */
    public int numeroDeVertices();  //tera que retornar a primeira linha do arquivo
